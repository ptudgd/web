...
<body>
	...
	<div class="container">
		<div class="row main">
			<div class="main-login main-center">
				<h2><b>CẬP NHẬT THÔNG TIN NHÀ CUNG CẤP</b></h2>	
				<form class="data_form">
					...
					<div class="form-group" hidden="true">
						<div class="cols-sm-10">
							<div class="input-group">
								...
								<input  type="text" class="form-control" name="CustomerId" id="CustomerId"  placeholder="Nhập họ tên"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group ">
						<button onclick="btnSave();return false;"  type="button" id="button" class="btn btn-primary btn-lg btn-block login-button">Lưu</button>
					</div>
	...
	<script>
		...
		<?php endif; ?>
			function btnSave() {
				var data = $("name").val();
				$.post('/api/Vender/VenderInput.php',
				{
					name : $("#name").val(),
					phone:$("#phone").val(),
					email: $("#email").val(),
