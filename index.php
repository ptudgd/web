...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/w2ui/css/w2ui-1.5.rc1.min.css">
    <script src="assets/w2ui/js/w2ui-1.5.rc1.min.js"></script>
...
<div class="container" id="main-container">
    ...
    <div id="sidebar" class="navbar-collapse collapse">
        ...
        <li class="<?= $i->isActive("Sale");?>">
            <a href="/index.php?page=Sale">
                <i class="fa fa-shopping-cart"></i>
                <span>Bán hàng</span>
            </a>
        </li>
        <li class="<?= $i->isActive("Employee");?>">
            <a href="/index.php?page=Employee">
                <i class="fa fa-user"></i>
                <span>Nhân viên</span>
            </a>
        </li>
        <li  class="<?= $i->isActive("Customer");?>">
            <a href="/index.php?page=Customer">
                <i class="fa fa-male"></i>
                <span>Khách hàng</span>
            </a>
        </li>
        <li  class="<?= $i->isActive("Vender");?> ">
            <a href="/index.php?page=Vender">
        ...
        <li>
            ...
            <!-- BEGIN Submenu -->
            <ul class="submenu">
                <li class="<?= $i->isActive("Product");?> "><a href="/index.php?page=Product">Danh sách hàng hóa</a></li>
                <li class="<?= $i->isActive("ProductGroup");?> "><a href="/index.php?page=ProductGroup">Danh sách nhóm hàng hóa</a></li>
            </ul>
            <!-- END Submenu -->
        </li>
    </ul>
